...
class tagmanager_ui {
    ...
    /**
     * Called from the hook. No longer renders inline UI - JavaScript handles button injection.
     * Kept for potential future use.
     */
    public static function inject(before_footer $hook): void {
        // JavaScript (exportmenu.js) now handles adding import/export buttons to each collection row.
